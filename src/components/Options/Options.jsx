...
const Options = ({ option, handleCorrectAnswer}) => {
  return (
    <div className='bg-violet-500 hover:bg-violet-900 focus:bg-violet-900 active:bg-violet-700  cursor-pointer  my-3 w-full lg:w-9/12 mx-auto rounded-lg text-white font-semibold z-0 '>
